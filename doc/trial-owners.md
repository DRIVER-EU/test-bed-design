...
- **Preparation support:** When preparing a Trial, practitioners can use the Trial-Management-Tool tool to create one or more scenarios for the Trial. In addition, they can already document the observations they wish to see using the Observer Support Tool. As part of the preparation, the Test-bed also offers:
